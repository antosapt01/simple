...
<body>
    ...
    <div class="container bg-white mt-5 p-4 text-secondary rounded">
        <div class="fs-3 fw-bold border-bottom pb-2 mb-4">Form Pengajuan</div>
        <form action="">
            <div class="mb-3">
                <label for="exampleFormControlInput1" class="form-label fw-bold">Bagaimana Cara Mengirimkan Lamaran?*</label>
            ...
            <button class="btn btn-primary" type="submit">Kirim Lowongan</button>
            <button class="btn btn-danger" type="cancel">Kembali</button>
        </form>
    </div>
