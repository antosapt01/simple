        ...
        <div class="row m-3">
            <div class="col-lg-8 col-md-8 col-sm-12">
                ...
                <div class="bg-light border-0 rounded p-3 mb-3">
                    <div class="col-12">
                        <h5 class="fw-bold">Kebijakan Beriklan</h5>
                        <div class="text-small text-secondary">Diperbarui pada 31 March 2022 16:26</div>
                    </div>
                    <div class="col-12 mt-4">
                        <div class="text-secondary">
                            Untuk posting iklan di www.lokersolo.id tidak kita pungut biaya alias gratis, tetapi untuk menjangkau lebih banyak calon pelamar kita ada beberapa paket iklan yg rinciannya ada di atas Keterangan:
                        </div>
                        <div class="text-secondary">
                            <ol class="list-group list-group-numbered my-2">
                                <li class="list-group-item border-0 text-secondary">
                                    Semua Iklan tidak dibatasi waktu tayang (unlimited), tetapi akan terus tergeser kebawah apabila ada iklan baru
                                </li>
                                <li class="list-group-item border-0 text-secondary">
                                    Jeda tiap posting adalah 3 hari sekali (untuk paket iklan > 2x posting dan apabila tidak ada request jadwal khusus dari klien)
                                </li>
                                <li class="list-group-item border-0 text-secondary">
                                    Boleh request tanggal/hari posting dengan jeda maksimal 7 hari dengan postingan sebelumnya
                                </li>
                                <li class="list-group-item border-0 text-secondary">
                                    Jam posting kami yang menentukan sesuai antrian
                                </li>
                            </ol>
                        </div>
                    </div>
